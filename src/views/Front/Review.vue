<template>
  <div class="coupon-section">
    ...
    <div
      class="coupon-bg d-flex justify-content-center align-items-center"
    ></div>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="card mb-3">
              <div class="card-body">
                ...
                <h5>蝦皮賣場</h5>
                <p class="ellipsis">
                  清洗完後像新的一樣，因軟管破損順便換新的，濾心賣家還換了一組新的給我
                </p>
              </div>
          ...
          <div class="col-lg-3 col-6">
            <div class="card mb-4">
              ...
              <div class="d-flex justify-content-center">
                <div class="pb-4">
                  <a
                    href="https://www.facebook.com/cleands717/reviews"
                    target="_blank"
                  >
          ...
          <div class="col-lg-3 col-6">
            <div class="card mb-4">
              <div class="card-body">
                <img
                  src="../../assets/images/share3.jpg"
                  alt=""
                  class="img-fluid rounded-circle w-50 mb-3"
                />
                <h5>Irenebaby</h5>
                <p class="ellipsis">
                  我們的Dyson無線手持系列吸塵器清潔交給清清小森-職人洗塵來守護
                </p>
              </div>
